...
public class SubjectManyToOne {
  ...
  public SubjectManyToOne(){}
  public SubjectManyToOne(SubjectId subjectId) {
    this.subjectId = subjectId;
  }
  public SubjectManyToOne(SubjectId subjectId, Student student){
    this.subjectId = subjectId;
